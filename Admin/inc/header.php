<div class="container-fluid bg-dark text-light p-3 d-flex align-items-center justify-content-between sticky-top">
    <h3 class="mb-0 h-font">Hotel Management System</h3>
    <a href="logout.php" class="btn btn-light btn-sm">LOGOUT</a>
</div>

<!-- Dashboard Sidebar -->
<div class="col-lg-2 bg-dark border-3 border-secondary" id="dashboard-menu">
        ...
        <div class="container-fluid flex-lg-column align-items-stretch">
            ...
            <div class="collapse navbar-collapse flex-column align-items-stretch mt-2" id="adminDropdown">
                <ul class="nav nav-pills flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-white" href="bookings_records.php"> Booking records</a>
                    </li>
                    </ul>
                    </div>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-white" href="rate_review.php">Rating and Review</a>
                    </li>
                    <li class="nav-item">
